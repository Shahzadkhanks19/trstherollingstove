...
export type ReceivableInvoiceDocument = InferSchemaType<
  typeof ReceivableInvoiceSchema
>;
export const ReceivableInvoice: Model<ReceivableInvoiceDocument> =
  (models.ReceivableInvoice as Model<ReceivableInvoiceDocument>) ||
  model<ReceivableInvoiceDocument>(
    "ReceivableInvoice",
