...
const ResolutionSchema = new Schema(
  {
    ...
    compensationType: {
      type: String,
      enum: ["none", "refund", "coupon", "coins", "replacement"],
      default: "none",
    },
    compensationValue: { type: Number, min: 0, default: 0 },
  },
...
const CustomerComplaintSchema = new Schema(
  {
    ...
    source: {
      type: String,
      enum: ["web", "admin", "email", "whatsapp", "phone", "review"],
      default: "web",
      index: true,
    },
...
CustomerComplaintSchema.index({ customerId: 1, createdAt: -1 });
export type CustomerComplaintDocument = InferSchemaType<
  typeof CustomerComplaintSchema
>;
export const CustomerComplaint: Model<CustomerComplaintDocument> =
  (models.CustomerComplaint as Model<CustomerComplaintDocument>) ||
  model<CustomerComplaintDocument>(
    "CustomerComplaint",
