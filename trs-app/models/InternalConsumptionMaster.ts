...
export const INTERNAL_MASTER_TYPES = [
  "department",
  "designation",
  "meal_category",
] as const;
...
export type InternalConsumptionMasterDocument = InferSchemaType<
  typeof InternalConsumptionMasterSchema
>;
export const InternalConsumptionMaster: Model<InternalConsumptionMasterDocument> =
  ...
  model<InternalConsumptionMasterDocument>(
    "InternalConsumptionMaster",
    InternalConsumptionMasterSchema,
  );
