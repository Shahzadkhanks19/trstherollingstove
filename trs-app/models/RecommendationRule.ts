...
const RecommendationRuleSchema = new Schema(
  {
    ...
    weight: { type: Number, min: -100, max: 100, default: 10 },
...
export type RecommendationRuleDocument = InferSchemaType<
  typeof RecommendationRuleSchema
>;
export const RecommendationRule: Model<RecommendationRuleDocument> =
  (models.RecommendationRule as Model<RecommendationRuleDocument>) ||
  model<RecommendationRuleDocument>(
    "RecommendationRule",
