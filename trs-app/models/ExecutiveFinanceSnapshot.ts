...
ExecutiveFinanceSnapshotSchema.index({
  periodEnd: -1,
  fiscalYear: -1,
  scenario: 1,
});
export type ExecutiveFinanceSnapshotRecord = InferSchemaType<
  typeof ExecutiveFinanceSnapshotSchema
>;
export const ExecutiveFinanceSnapshot: Model<ExecutiveFinanceSnapshotRecord> =
  ...
  model<ExecutiveFinanceSnapshotRecord>(
    "ExecutiveFinanceSnapshot",
    ExecutiveFinanceSnapshotSchema,
  );
