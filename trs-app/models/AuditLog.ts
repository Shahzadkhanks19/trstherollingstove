...
const schema = new Schema(
  {
    ...
    entityId: { type: String, default: "", index: true, trim: true },
    description: { type: String, required: true, maxlength: 500, trim: true },
    metadata: { type: Schema.Types.Mixed, default: {} },
    ipAddress: { type: String, default: "", maxlength: 100, trim: true },
    userAgent: { type: String, default: "", maxlength: 500, trim: true },
  },
...
export const AuditLog: Model<AuditLogDocument> =
  ...
  model<AuditLogDocument>("AuditLog", schema);
