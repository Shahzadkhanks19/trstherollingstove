...
export type FinanceAuditEventDocument = InferSchemaType<
  typeof financeAuditEventSchema
>;
export const FinanceAuditEvent =
  models.FinanceAuditEvent ??
  model("FinanceAuditEvent", financeAuditEventSchema);
