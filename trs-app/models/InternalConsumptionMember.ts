...
export type InternalConsumptionMemberDocument = InferSchemaType<
  typeof InternalConsumptionMemberSchema
>;
export const InternalConsumptionMember: Model<InternalConsumptionMemberDocument> =
  ...
  model<InternalConsumptionMemberDocument>(
    "InternalConsumptionMember",
    InternalConsumptionMemberSchema,
  );
