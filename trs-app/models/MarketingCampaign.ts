...
const MarketingCampaignSchema = new Schema(
  {
    ...
    audience: {
      type: {
        type: String,
        enum: ["all", "segment", "risk", "manual"],
        default: "all",
      },
      segmentKeys: [{ type: String, trim: true, lowercase: true }],
...
>;
export const MarketingCampaign: Model<MarketingCampaignDocument> =
  (models.MarketingCampaign as Model<MarketingCampaignDocument>) ||
  model<MarketingCampaignDocument>(
    "MarketingCampaign",
