...
export const LoyaltyTier: Model<LoyaltyTierDocument> =
  (models.LoyaltyTier as Model<LoyaltyTierDocument>) ||
  model<LoyaltyTierDocument>("LoyaltyTier", LoyaltyTierSchema);
