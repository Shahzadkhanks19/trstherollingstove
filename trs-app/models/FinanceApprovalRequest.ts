...
export type FinanceApprovalRequestDocument = InferSchemaType<
  typeof financeApprovalRequestSchema
>;
export const FinanceApprovalRequest =
  models.FinanceApprovalRequest ??
  model("FinanceApprovalRequest", financeApprovalRequestSchema);
