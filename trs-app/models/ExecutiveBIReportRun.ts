...
export type ExecutiveBIReportRunDocument = InferSchemaType<
  typeof ExecutiveBIReportRunSchema
>;
export const ExecutiveBIReportRun: Model<ExecutiveBIReportRunDocument> =
  (models.ExecutiveBIReportRun as
    Model<ExecutiveBIReportRunDocument> | undefined) ??
  model<ExecutiveBIReportRunDocument>(
    "ExecutiveBIReportRun",
    ExecutiveBIReportRunSchema,
  );
