...
const InternalConsumptionPolicySchema = new Schema(
  {
    ...
    scopeType: {
      type: String,
      enum: ["global", "staff", "department", "designation"],
      required: true,
      index: true,
    },
    ...
    allowedMealCategoryIds: [
      { type: Schema.Types.ObjectId, ref: "InternalConsumptionMaster" },
    ],
...
InternalConsumptionPolicySchema.index({
  scopeType: 1,
  scopeId: 1,
  isActive: 1,
  priority: 1,
...
export type InternalConsumptionPolicyDocument = InferSchemaType<
  typeof InternalConsumptionPolicySchema
>;
export const InternalConsumptionPolicy: Model<InternalConsumptionPolicyDocument> =
  ...
  model<InternalConsumptionPolicyDocument>(
    "InternalConsumptionPolicy",
    InternalConsumptionPolicySchema,
  );
