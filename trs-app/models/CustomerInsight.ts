...
const CustomerInsightSchema = new Schema(
  {
    ...
    visitFrequencyDays: { type: Number, min: 0, default: 0 },
    daysSinceLastOrder: { type: Number, min: 0, default: 0 },
    lastOrderAt: { type: Date, default: null },
    firstOrderAt: { type: Date, default: null },
    reservationCount: { type: Number, min: 0, default: 0 },
    completedReservationCount: { type: Number, min: 0, default: 0 },
    noShowCount: { type: Number, min: 0, default: 0 },
    reviewCount: { type: Number, min: 0, default: 0 },
    averageRating: { type: Number, min: 0, max: 5, default: 0 },
    referralCount: { type: Number, min: 0, default: 0 },
    ...
    preferredOrderMode: {
      type: String,
      enum: ["dine_in", "takeaway", "none"],
      default: "none",
    },
    preferredVisitHour: { type: Number, min: 0, max: 23, default: null },
    preferredTable: { type: String, trim: true, maxlength: 30, default: "" },
    segmentKeys: { type: [String], default: [], index: true },
    riskLevel: {
      type: String,
...
export type CustomerInsightDocument = InferSchemaType<
  typeof CustomerInsightSchema
>;
export const CustomerInsight: Model<CustomerInsightDocument> =
  (models.CustomerInsight as Model<CustomerInsightDocument>) ||
  model<CustomerInsightDocument>("CustomerInsight", CustomerInsightSchema);
