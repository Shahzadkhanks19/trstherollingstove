...
export type PurchaseReturnDocument = InferSchemaType<
  typeof PurchaseReturnSchema
>;
export const PurchaseReturn: Model<PurchaseReturnDocument> =
  (models.PurchaseReturn as Model<PurchaseReturnDocument>) ||
  model<PurchaseReturnDocument>("PurchaseReturn", PurchaseReturnSchema);
