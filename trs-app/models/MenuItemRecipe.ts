...
export type MenuItemRecipeDocument = InferSchemaType<
  typeof MenuItemRecipeSchema
>;
export const MenuItemRecipe: Model<MenuItemRecipeDocument> =
  (models.MenuItemRecipe as Model<MenuItemRecipeDocument>) ||
  model<MenuItemRecipeDocument>("MenuItemRecipe", MenuItemRecipeSchema);
