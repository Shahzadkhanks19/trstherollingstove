...
SupplierIntelligenceSnapshotSchema.index({
  runId: 1,
  overallScore: -1,
  totalSpend: -1,
});
SupplierIntelligenceSnapshotSchema.index({ supplierId: 1, generatedAt: -1 });
export type SupplierIntelligenceSnapshotDocument = InferSchemaType<
  typeof SupplierIntelligenceSnapshotSchema
>;
export const SupplierIntelligenceSnapshot: Model<SupplierIntelligenceSnapshotDocument> =
  (models.SupplierIntelligenceSnapshot as
    Model<SupplierIntelligenceSnapshotDocument> | undefined) ??
  model<SupplierIntelligenceSnapshotDocument>(
    "SupplierIntelligenceSnapshot",
    SupplierIntelligenceSnapshotSchema,
  );
