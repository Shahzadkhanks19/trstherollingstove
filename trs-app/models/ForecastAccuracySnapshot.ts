...
export type ForecastAccuracySnapshotDocument = InferSchemaType<
  typeof ForecastAccuracySnapshotSchema
>;
export const ForecastAccuracySnapshot: Model<ForecastAccuracySnapshotDocument> =
  (models.ForecastAccuracySnapshot as Model<ForecastAccuracySnapshotDocument>) ||
  model<ForecastAccuracySnapshotDocument>(
    "ForecastAccuracySnapshot",
    ForecastAccuracySnapshotSchema,
  );
