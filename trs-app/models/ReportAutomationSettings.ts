...
export type ReportAutomationSettingsDocument = InferSchemaType<
  typeof ReportAutomationSettingsSchema
>;
export const ReportAutomationSettings: Model<ReportAutomationSettingsDocument> =
  ...
  model<ReportAutomationSettingsDocument>(
    "ReportAutomationSettings",
    ReportAutomationSettingsSchema,
  );
