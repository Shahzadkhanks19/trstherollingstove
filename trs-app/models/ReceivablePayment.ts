...
export type ReceivablePaymentDocument = InferSchemaType<
  typeof ReceivablePaymentSchema
>;
export const ReceivablePayment: Model<ReceivablePaymentDocument> =
  (models.ReceivablePayment as Model<ReceivablePaymentDocument>) ||
  model<ReceivablePaymentDocument>(
    "ReceivablePayment",
