...
export type EnterpriseHealthSnapshotDocument = InferSchemaType<
  typeof EnterpriseHealthSnapshotSchema
>;
export const EnterpriseHealthSnapshot: Model<EnterpriseHealthSnapshotDocument> =
  (models.EnterpriseHealthSnapshot as
    Model<EnterpriseHealthSnapshotDocument> | undefined) ??
  model<EnterpriseHealthSnapshotDocument>(
    "EnterpriseHealthSnapshot",
    EnterpriseHealthSnapshotSchema,
  );
