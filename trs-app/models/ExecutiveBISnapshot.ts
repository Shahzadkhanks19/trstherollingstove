...
export type ExecutiveBISnapshotDocument = InferSchemaType<
  typeof ExecutiveBISnapshotSchema
>;
export const ExecutiveBISnapshot: Model<ExecutiveBISnapshotDocument> =
  (models.ExecutiveBISnapshot as
    Model<ExecutiveBISnapshotDocument> | undefined) ??
  model<ExecutiveBISnapshotDocument>(
    "ExecutiveBISnapshot",
    ExecutiveBISnapshotSchema,
  );
