...
export type ReportExecutionDocument = InferSchemaType<
  typeof ReportExecutionSchema
>;
export const ReportExecution: Model<ReportExecutionDocument> =
  (models.ReportExecution as Model<ReportExecutionDocument>) ||
  model<ReportExecutionDocument>("ReportExecution", ReportExecutionSchema);
