...
export const KitchenProductionRecipe: Model<KitchenProductionRecipeDocument> =
  (models.KitchenProductionRecipe as Model<KitchenProductionRecipeDocument>) ||
  model<KitchenProductionRecipeDocument>("KitchenProductionRecipe", SchemaDef);
