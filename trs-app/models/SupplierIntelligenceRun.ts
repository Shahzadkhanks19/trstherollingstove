...
export type SupplierIntelligenceRunDocument = InferSchemaType<
  typeof SupplierIntelligenceRunSchema
>;
export const SupplierIntelligenceRun: Model<SupplierIntelligenceRunDocument> =
  (models.SupplierIntelligenceRun as
    Model<SupplierIntelligenceRunDocument> | undefined) ??
  model<SupplierIntelligenceRunDocument>(
    "SupplierIntelligenceRun",
    SupplierIntelligenceRunSchema,
  );
