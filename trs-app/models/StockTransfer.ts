...
export const StockTransfer: Model<StockTransferDocument> =
  (models.StockTransfer as Model<StockTransferDocument>) ||
  model<StockTransferDocument>("StockTransfer", StockTransferSchema);
