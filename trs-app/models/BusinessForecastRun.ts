...
export type BusinessForecastRunDocument = InferSchemaType<
  typeof BusinessForecastRunSchema
>;
export const BusinessForecastRun: Model<BusinessForecastRunDocument> =
  (models.BusinessForecastRun as Model<BusinessForecastRunDocument>) ||
  model<BusinessForecastRunDocument>(
    "BusinessForecastRun",
    BusinessForecastRunSchema,
  );
