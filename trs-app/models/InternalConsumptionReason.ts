...
export type InternalConsumptionReasonDocument = InferSchemaType<
  typeof InternalConsumptionReasonSchema
>;
export const InternalConsumptionReason: Model<InternalConsumptionReasonDocument> =
  ...
  model<InternalConsumptionReasonDocument>(
    "InternalConsumptionReason",
    InternalConsumptionReasonSchema,
  );
