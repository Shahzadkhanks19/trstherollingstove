...
export const INTERNAL_DIRECTORY_TYPES = [
  "family_member",
...
InternalConsumptionDirectorySchema.index(
  { type: 1, name: 1 },
...
export type InternalConsumptionDirectoryDocument = InferSchemaType<
  typeof InternalConsumptionDirectorySchema
>;
export const InternalConsumptionDirectory: Model<InternalConsumptionDirectoryDocument> =
  ...
  model<InternalConsumptionDirectoryDocument>(
    "InternalConsumptionDirectory",
    InternalConsumptionDirectorySchema,
  );
