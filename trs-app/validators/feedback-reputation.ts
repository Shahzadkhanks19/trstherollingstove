  ...
  resolution: z
    .object({
      ...
      compensationType: z
        ...
        .default("none"),
      compensationValue: z.number().min(0).default(0),
    })
    .optional(),
});
export const npsCreateSchema = z.object({
  ...
  source: z.enum(["web", "email", "whatsapp", "sms", "admin"]).default("web"),
...
export const integrationUpdateSchema = z.object({
  isEnabled: z.boolean(),
  locationId: z.string().trim().max(200).default(""),
  accountId: z.string().trim().max(200).default(""),
