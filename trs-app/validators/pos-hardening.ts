...
import {
  ...
  transferRunningOrderSchema,
  voidRunningItemSchema,
  updateTableSchema,
} from "@/validators/pos-operations";
...
export const offlineSyncSchema = z.object({
  ...
  operations: z
    .array(
      z.discriminatedUnion("operationType", [
        operationBase.extend({
          operationType: z.literal("running_order.update"),
          payload: updateRunningOrderSchema,
        }),
        operationBase.extend({
          operationType: z.literal("running_order.transfer"),
          payload: transferRunningOrderSchema,
        }),
        operationBase.extend({
          operationType: z.literal("running_order.void_item"),
          payload: voidRunningItemSchema,
        }),
        operationBase.extend({
          operationType: z.literal("table.update"),
