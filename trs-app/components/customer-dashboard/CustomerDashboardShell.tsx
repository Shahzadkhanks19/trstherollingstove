...
const links = [
  ...
  {
    href: "/customer-dashboard/rewards",
    label: "Rewards & Coins",
    icon: faCoins,
  },
  ...
  const sidebar = (
    <div className="flex h-full flex-col bg-[#111] text-white">
      <div className="border-b border-white/10 px-6 py-6">
        <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-[#D9A441]">
          TRS Customer
        </p>
      ...
      <div className="border-t border-white/10 p-4">
        <button
          onClick={logout}
          disabled={loggingOut}
          className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-bold text-white/75 transition hover:bg-white/10 hover:text-white disabled:opacity-60"
        >
        ...
        <div className="min-w-0">
          <header className="sticky top-0 z-30 flex items-center justify-between border-b border-black/5 bg-white/95 px-4 py-4 backdrop-blur md:px-8">
            <button
              ...
              className="grid h-11 w-11 place-items-center rounded-xl border border-black/10 lg:hidden"
              aria-label="Open dashboard menu"
            >
              <FontAwesomeIcon icon={faBars} />
            </button>
            <div>
              <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-[#A50E27]">
                The Rolling Stove
              </p>
            ...
            <Link
              href="/customer-dashboard/profile"
              className="grid h-11 w-11 place-items-center rounded-full bg-[#111] text-white"
