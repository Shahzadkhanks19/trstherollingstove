            ...
            <aside className="space-y-4 lg:sticky lg:top-24 lg:h-fit">
              <section className="rounded-3xl border border-[#E9E1D9] bg-white p-5 shadow-[0_18px_50px_rgba(54,35,20,.07)]">
                <div className="flex justify-between gap-3">
                  ...
                  <Link
                    href="/cart"
                    className="text-[9px] font-black text-[#E3172F]"
                  >
                    ...
                    <div key={item.id} className="flex gap-3 py-4 first:pt-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {item.modifiers.map((m) => (
                          <p key={m} className="mt-1 text-[8px]">
                            + {m}
                          </p>
                        ))}
                      </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-[9px] leading-4 text-[#6B5E4F]">
                          ...
                          contains a combo or a discounted menu item. You will
                          still earn TRS Coins on the final selling price after
                          successful payment.
                        </p>
                      </div>
                    </div>
                ...
                <p className="mt-3 text-[9px]">
                  ...
                  />
                  Earn{" "}
                  <strong className="text-[#E3172F]">
                    {coinsEarned} TRS Coins
                  </strong>
                </p>
                <button
                  type="button"
                ...
                <p className="mt-3 text-center text-[8px] leading-4 text-[#746A63]">
                  No cash or pay-at-counter orders. Preparation starts after
                  verified payment.
                </p>
              </section>
              <section className="grid grid-cols-2 gap-3 rounded-2xl border bg-white p-4 text-[8px]">
                ...
                <span>
                  ...
                  />
                  <strong>
                    {settings.preparationTimeMinutes} min estimate
                  </strong>
                </span>
              </section>
            </aside>
